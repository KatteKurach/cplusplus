...
DWORD WINAPI draw(LPVOID lpParam)
{
	...
	while (true) {
		...
		Sleep(150);
		ReleaseSemaphore(h_semaphore, 1, NULL); //add_count
	}
	return 0;
}
	...
	_In_ int       nCmdShow)
{
	...
	LoadStringW(hInstance, IDC_LABA7_2, szWindowClass, MAX_LOADSTRING);
	...
	HACCEL hAccelTable = LoadAccelerators(hInstance, MAKEINTRESOURCE(IDC_LABA7_2));
...
ATOM MyRegisterClass(HINSTANCE hInstance)
{
	...
	wcex.hIcon = LoadIcon(hInstance, MAKEINTRESOURCE(IDI_LABA7_2));
	wcex.hCursor = LoadCursor(nullptr, IDC_ARROW);
	wcex.hbrBackground = (HBRUSH)(COLOR_WINDOW + 1);
	wcex.lpszMenuName = MAKEINTRESOURCEW(IDC_LABA7_2);
...
LRESULT CALLBACK WndProc(HWND hWnd, UINT message, WPARAM wParam, LPARAM lParam)
{
	...
	case WM_CREATE:
	{
		h_semaphore = CreateSemaphore(NULL, 1, 1, NULL); //how much me can, count of threads
